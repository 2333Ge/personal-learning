...
- ## 判断题
  ...
  console.log('是否为空：'，!!subObj.__proto__.__proto__.superMethod,'结果：',subObj.__proto__.__proto__.superMethod?.())
  ```
  ...
  console.log(Child.prototype.data === childInstance.__proto__.data)
  ```
